Library Management System - MongoDB Commands

This document outlines the MongoDB shell commands used to implement a Library Management System.
...
db.books.updateOne(
  { _id: 8 },
  { $addToSet: { genres: "War Fiction" } }
)

// Add borrowed book to patron
db.patrons.updateOne(
  { _id: 5 },
  { $push: { borrowed_books: 3 } }
)
```
